                ...
                <SheetContent className="bg-black">
                    ...
                    <section className="min-h-md flex flex-col justify-center bg-white bg-opacity-85 py-12 px-4 sm:px-6 lg:px-8">
                        <div className="text-center">
                            ...
                            <button className="mt-4 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-500 hover:bg-white hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                Continue Comprando
                            </button>
                        </div>
                    </section>
