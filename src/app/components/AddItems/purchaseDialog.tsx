...
const PurchaseDialog = () => {
  ...
  const handleConfirmPurchase = () => {
    // Aqui você pode adicionar lógica adicional, como validação do formulário ou envio dos dados
  ...
  return (
    <AlertDialog>
      ...
      <div className="alertDialogOverlay">
        <AlertDialogContent className="alertDialogContent bg-gray-400">
          {!purchaseCompleted ? (
            <>
              <AlertDialogCancel className="absolute top-2 right-2 rounded-full text-white">
                <CircleX />
              </AlertDialogCancel>
              <AlertDialogTitle className="text-2xl text-white mb-4">
              ...
              <AlertDialogFooter className="mt-4 flex justify-end">
                <button
                  ...
                  className="text-lg py-2 px-3 border border-green-800 bg-green-500 bg-opacity-20 hover:bg-green-500 hover:text-white rounded-md"
                >
                  Confirmar Compra
                </button>
              </AlertDialogFooter>
            ...
            <div className="text-center">
              ...
              <p className="text-white">Obrigado pela sua compra!</p>
            </div>
          )}
        </AlertDialogContent>
      </div>
