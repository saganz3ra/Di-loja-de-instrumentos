...
export function PersonalButton() {
    return (
        <section className="flex space-x-4">
            ...
            <Sheet>
                <SheetTrigger className="mt-2 text-white rounded-sm h-12  justify-center items-center text-5xl hover:bg-white hover:text-black"><ShoppingCart /></SheetTrigger>
                <SheetContent className="bg-black">
                    <SheetHeader>
            ...
            <Sheet>
                <SheetTrigger className="mt-2 text-white rounded-sm h-12  justify-center items-center text-5xl hover:bg-white hover:text-black"><Heart /></SheetTrigger>
                <SheetContent className="bg-black">
                    <SheetHeader>
                        <SheetTitle className="text-5xl text-white mb-2">Favoritos</SheetTitle>
                    </SheetHeader>
                    <section className=" min-h-md flex flex-col justify-center bg-white bg-opacity-85 py-12 px-4 sm:px-6 lg:px-8 ">
                        <SheetDescription className="mb-2  italic"><p>Faça seu login para interagir com a comunidade!</p>
                        </SheetDescription>
